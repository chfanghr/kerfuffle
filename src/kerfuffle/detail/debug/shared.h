...
static inline const char* stateName(const std::type_index stateType) {
...
static inline const char* methodName(const Method method) {
  switch (method) {
#ifdef KERFUFFLE_ENABLE_UTILITY_THEORY
    case Method::RANK:
      return "rank";
...
static inline const char* transitionName(const TransitionType transitionType) {
