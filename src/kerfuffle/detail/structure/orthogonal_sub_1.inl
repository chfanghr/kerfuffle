...
template <typename T>
T& OS_<TN, TA, NI, TI, TR...>::access() {
  return InitialStates::template contains<T>() ? initial.template access<T>()
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
template <typename T>
const T& OS_<TN, TA, NI, TI, TR...>::access() const {
  return InitialStates::template contains<T>() ? initial.template access<T>()
                                               : remaining.template access<T>();
}
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideRegister(Registry&    registry,
                                              const ForkID forkId) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
bool OS_<TN, TA, NI, TI, TR...>::wideForwardEntryGuard(
    GuardControl& control, const ProngConstBits prongs) {
  const bool i =
      prongs.get(PRONG_INDEX) ? initial.deepForwardEntryGuard(control) : false;
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
bool OS_<TN, TA, NI, TI, TR...>::wideForwardEntryGuard(GuardControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
bool OS_<TN, TA, NI, TI, TR...>::wideEntryGuard(GuardControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideConstruct(PlanControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideEnter(PlanControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideReenter(PlanControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
Status OS_<TN, TA, NI, TI, TR...>::wideUpdate(FullControl& control) {
...
Status OS_<TN, TA, NI, TI, TR...>::wideReact(FullControl&  control,
                                             const TEvent& event) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
bool OS_<TN, TA, NI, TI, TR...>::wideForwardExitGuard(
    GuardControl& control, const ProngConstBits prongs) {
  const bool i =
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
bool OS_<TN, TA, NI, TI, TR...>::wideForwardExitGuard(GuardControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
bool OS_<TN, TA, NI, TI, TR...>::wideExitGuard(GuardControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideExit(PlanControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideDestruct(PlanControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideForwardActive(
    Control&             control,
    const Request::Type  request,
    const ProngConstBits prongs) {
  const Request::Type local =
      prongs.get(PRONG_INDEX) ? request : Request::REMAIN;
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideForwardRequest(
    Control&             control,
    const Request::Type  request,
    const ProngConstBits prongs) {
  const Request::Type local =
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideRequestChange(Control& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideRequestRemain(Registry& registry) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideRequestRestart(Registry& registry) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideRequestResume(Registry& registry) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideRequestUtilize(Control& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideRequestRandomize(Control& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
typename TA::Utility OS_<TN, TA, NI, TI, TR...>::wideReportChange(
    Control& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
typename TA::Utility OS_<TN, TA, NI, TI, TR...>::wideReportUtilize(
    Control& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
typename TA::Utility OS_<TN, TA, NI, TI, TR...>::wideReportRandomize(
    Control& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideChangeToRequested(PlanControl& control) {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideSaveActive(const Registry& registry,
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideSaveResumable(const Registry& registry,
                                                   WriteStream& stream) const {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideLoadRequested(Registry&   registry,
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideLoadResumable(Registry&   registry,
                                                   ReadStream& stream) const {
...
template <typename TN, typename TA, ShortIndex NI, typename TI, typename... TR>
void OS_<TN, TA, NI, TI, TR...>::wideGetNames(
    const LongIndex      parent,
    const ShortIndex     depth,
    StructureStateInfos& stateInfos) const {
  initial.deepGetNames(
      parent, StructureStateInfo::ORTHOGONAL, depth, stateInfos);
