...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
template <typename T>
const T& CS_<TN, TA, SG, NI, TS...>::access() const {
  return LHalfInfo::StateList::template contains<T>()
             ? lHalf.template access<T>()
             : rHalf.template access<T>();
}
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideRegister(Registry&    registry,
                                              const Parent parent) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
bool CS_<TN, TA, SG, NI, TS...>::wideForwardEntryGuard(GuardControl&    control,
                                                       const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
bool CS_<TN, TA, SG, NI, TS...>::wideEntryGuard(GuardControl&    control,
                                                const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideConstruct(PlanControl&     control,
                                               const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideEnter(PlanControl&     control,
                                           const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideReenter(PlanControl&     control,
                                             const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
Status CS_<TN, TA, SG, NI, TS...>::wideUpdate(FullControl&     control,
                                              const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
Status CS_<TN, TA, SG, NI, TS...>::wideReact(FullControl&     control,
                                             const TEvent&    event,
                                             const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
bool CS_<TN, TA, SG, NI, TS...>::wideForwardExitGuard(GuardControl&    control,
                                                      const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
bool CS_<TN, TA, SG, NI, TS...>::wideExitGuard(GuardControl&    control,
                                               const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideExit(PlanControl&     control,
                                          const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideDestruct(PlanControl&     control,
                                              const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideForwardActive(Control&            control,
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideForwardRequest(Control&            control,
                                                    const Request::Type request,
                                                    const ShortIndex    prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideRequestChangeComposite(Control& control) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideRequestChangeResumable(
    Control& control, const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideRequestRemain(Registry& registry) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideRequestRestart(Registry& registry) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideRequestResume(Registry&        registry,
                                                   const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
typename TA::UP CS_<TN, TA, SG, NI, TS...>::wideReportUtilize(
    Control& control) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
typename TA::Rank CS_<TN, TA, SG, NI, TS...>::wideReportRank(
    Control& control, Rank* const ranks) {
  KERFUFFLE_ASSERT(ranks);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
typename TA::UP CS_<TN, TA, SG, NI, TS...>::wideReportChangeComposite(
    Control& control) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
typename TA::UP CS_<TN, TA, SG, NI, TS...>::wideReportChangeResumable(
    Control& control, const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
typename TA::UP CS_<TN, TA, SG, NI, TS...>::wideReportChangeUtilitarian(
    Control& control) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
typename TA::Utility CS_<TN, TA, SG, NI, TS...>::wideReportChangeRandom(
    Control&          control,
    Utility* const    options,
    const Rank* const ranks,
    const Rank        top) {
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideChangeToRequested(PlanControl&     control,
                                                       const ShortIndex prong) {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideSaveActive(const Registry&  registry,
                                                WriteStream&     stream,
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideSaveResumable(const Registry& registry,
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideLoadRequested(
    Registry& registry, ReadStream& stream, const ShortIndex prong) const {
  KERFUFFLE_ASSERT(prong != INVALID_SHORT_INDEX);
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideLoadResumable(Registry&   registry,
...
template <typename TN, typename TA, Strategy SG, ShortIndex NI, typename... TS>
void CS_<TN, TA, SG, NI, TS...>::wideGetNames(
